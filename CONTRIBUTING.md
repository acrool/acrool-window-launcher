...
- Create an [issue](https://github.com/acrool/acrool-windows-launcher/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-windows-launcher/issues), assuming one does not already exist.
